...
class APTabBarItemContentView: ESTabBarItemContentView {

    override init(frame: CGRect) {
        super.init(frame: frame)
        renderingMode = .alwaysOriginal
//        textColor = UIColor(hex6:0x9a9a9a , alpha: 1)
//        highlightTextColor = UIColor(hex6:0xc8a965 , alpha: 1)
//        iconColor = UIColor(hex6:0xffffff , alpha: 1)
//        highlightIconColor = UIColor(hex6:0xc8a965 , alpha: 1)
        textColor = .clear
...
class APIrregularityContentView: ESTabBarItemContentView {

...
class APEarningsHttpTool: NSObject {
    static func getProfitHome(_ params : APBaseRequest, success : @escaping APNetWorkingSuccessBlock,faile : @escaping APNetWorkingFaileBlock){
        APNetworking.get(httpUrl: APHttpUrl.manange_httpUrl, action: APHttpService.getProfitHome, params: params, aClass: APBaseResponse.self, success: success, failure: faile)
    }
    static func getUserListRecommend(_ params : APBaseRequest, success : @escaping APNetWorkingSuccessBlock,faile : @escaping APNetWorkingFaileBlock){
        APNetworking.get(httpUrl: APHttpUrl.manange_httpUrl, action: APHttpService.getUserListRecommend, params: params, aClass: APBaseResponse.self, success: success, failure: faile)
    ...
    static func getMyProfit(_ params : APBaseRequest, success : @escaping APNetWorkingSuccessBlock,faile : @escaping APNetWorkingFaileBlock){
        APNetworking.get(httpUrl: APHttpUrl.manange_httpUrl, action: APHttpService.getMyProfit, params: params, aClass: APBaseResponse.self, success: success, failure: faile)

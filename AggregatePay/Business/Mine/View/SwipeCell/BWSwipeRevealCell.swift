...
open class BWSwipeRevealCell: BWSwipeCell {
    ...
    open var backViewbackgroundColor: UIColor = UIColor.black
    ...
    open var bgViewInactiveColor: UIColor = UIColor.black
    open var bgViewLeftColor: UIColor = UIColor.black
    open var bgViewRightColor: UIColor = UIColor.black
    ...
    open var rightBackButton:UIButton? {
        if _rightBackButton == nil {
            ...
            _rightBackButton?.snp.makeConstraints({ (make) in
                make.right.equalTo((self.backView?.snp.right)!).offset(-20)
...
//            let minY = frame.minY
//            self.rightBackButton!.frame = (CGRect(x: maxX, y: 5, width: frame.width, height: frame.height))
//            self.rightBackButton?.layoutIfNeeded()

 ...
 * 输入支付要素
 */
class APPayEssentialViewController: APBaseViewController {
...
//        }
    ...
    //头信息
    lazy var headerView: APPayEssentialHeaderView = {
        let view = APPayEssentialHeaderView()
        return view
    }()
    
    lazy var toolBarView: APPayEssentialToolBarView = {
        let view = APPayEssentialToolBarView()
        return view
    }()
    
    //信用卡卡号
    lazy var bankCardNoCell: APPayEssentialTextCell = {
        let view = APPayEssentialTextCell()
    ...
    //CVN2
    lazy var cvnNoCell: APPayEssentialTextCell = {
        let view = APPayEssentialTextCell()
    ...
    //有效期
    lazy var validityDateCell: APPayEssentialTextCell = {
        let view = APPayEssentialTextCell()
    ...
    //预留手机号
    lazy var phoneNoCell: APPayEssentialTextCell = {
        let view = APPayEssentialTextCell()
    ...
    //验证码
    lazy var smsCodeCell: APPayEssentialSmsCodeCell = {
        let view = APPayEssentialSmsCodeCell()
